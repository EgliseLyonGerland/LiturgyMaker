...
it('getPassage() with "1 Pierre 1"', async () => {
...
it('getPassage() with "1 Pierre 1-2"', async () => {
...
it('getPassage() with "1 Pierre 1-4"', async () => {
...
it('getPassage() with "1 Pierre 1.1"', async () => {
...
it('getPassage() with "1 Pierre 1.1-4"', async () => {
...
it('getPassage() with "1 Pierre 1.10-2.2"', async () => {
...
it('getPassage() with "1 Pierre 1.1-4.4"', async () => {
