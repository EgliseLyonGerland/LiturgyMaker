...
interface RevealOptions {
  ...
  // Slideshow Size
  // https://github.com/hakimel/reveal.js/#slideshow-size
...
interface MultiplexConfig {
  // Obtained from the socket.io server. Gives this (the master) control of the slideshow
